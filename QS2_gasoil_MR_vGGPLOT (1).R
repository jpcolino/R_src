...
g <- ggplot(df_spreads, aes(x=x))

print(g+
	geom_line(aes(y = sma13),colour='red',size=1.2)+
	geom_line(aes(y = s13),linetype="dashed",colour='darkred',size=.1)+
	geom_line(aes(y = sma12),colour='blue',size=1.2)+
  geom_line(aes(y = s12),linetype="dashed",colour='darkblue',size=.1)+
  geom_line(aes(y = sma11),colour='green',size=1.2)+
  geom_line(aes(y = s11),linetype="dashed",colour='darkgreen',size=.1)+
  geom_line(aes(y = sma10),colour='grey',size=1.2)+
  geom_line(aes(y = s10),linetype="dashed",colour='darkgrey',size=.1)+
...
print(g+
  ...
  geom_area(aes(y = s11), fill="green", alpha=0.6)+
  #geom_line(aes(y = sma11),size=1.2)+
  geom_area(aes(y = s12),  fill="red", alpha=0.4)+
  #geom_line(aes(y = sma10),size=1.2)+
  geom_area(aes(y = s13), fill="blue", alpha=0.2)+
...
print(ggplot(df_spreads, aes(x=s10)) + 
geom_histogram(fill="white", colour="black") + 
ggtitle("Histogram Spreads for 2010"))


print(ggplot(df_spreads, aes(x=s10)) + 
geom_histogram(aes(x=s10),fill="white") + 
geom_histogram(aes(x=s11),fill="green", alpha=0.6) + 
geom_histogram(aes(x=s12),fill="red", alpha=0.4) + 
geom_histogram(aes(x=s13),fill="blue", alpha=0.2) + 
ggtitle("Histogram Spreads for 2010 - 2011 - 2012 - 2014"))

d1<- ggplot(df_spreads, aes(x=s10)) + 
geom_density(aes(x=s10),fill="white") + 
geom_density(aes(x=s11),fill="green", alpha=0.6) + 
geom_density(aes(x=s12),fill="red", alpha=0.4) + EMA(MovingVol13, 20)
geom_density(aes(x=s13),fill="blue", alpha=0.2) + 
ggtitle("Densities of the Spreads for 2010(white) - 2011(green) - 2012(red) - 2014(blue)")

d2<-ggplot(D_spreads, aes(x=Ds10)) + 
geom_density(aes(x=Ds10),fill="white") + 
geom_density(aes(x=Ds11),fill="green", alpha=0.6) + 
geom_density(aes(x=Ds12),fill="red", alpha=0.4) + 
geom_density(aes(x=Ds13),fill="blue", alpha=0.2) + 
...
v_std <- std2(beta_0,beta_1,na.fill(MovingVol11,"extend"))
...
p211 <-  ggplot(df_prices211, aes(x = df_prices211$x)) + 
         ...
         geom_ribbon (aes(ymin = (df_prices211$mean_10 - 1.5 * df_prices211$var_10), 
                          ymax = (df_prices211$mean_10 + 1.5 * df_prices211$var_10)), alpha=0.4) + 
         geom_ribbon (aes(ymin = (df_prices211$mean_10 - v_std * df_prices211$var_10), 
                          ymax = (df_prices211$mean_10 + v_std * df_prices211$var_10)), fill='green',alpha=0.2) +
         ggtitle('2011 Gas-Oil Spread and MeanRev IC from 2010')
...
v_std <- std2(beta_0,beta_1,na.fill(MovingVol12,"extend"))
...
p212 <-  ggplot(df_prices212, aes(x = df_prices212$x)) + 
         ...
         geom_ribbon (aes(ymin = (df_prices212$mean_11 - 1.5 * df_prices212$var_11), 
                          ymax = (df_prices212$mean_11 + 1.5 * df_prices212$var_11)), alpha=0.4) + 
         geom_ribbon (aes(ymin = (df_prices212$mean_11 - v_std * df_prices212$var_11), 
                          ymax = (df_prices212$mean_11 + v_std * df_prices212$var_11)), fill = 'green', alpha=0.2) +
         ggtitle('2011 Gas-Oil Spread and MeanRev IC from 2010')
...
v_std <- std2(beta_0, beta_1, na.fill(MovingVol13,"extend"))
...
p213 <-  ggplot(df_prices213, aes(x = df_prices213$x)) + 
         ...
         geom_ribbon (aes(ymin = (df_prices213$mean_12 - 1.5 * df_prices213$var_12), 
                          ymax = (df_prices213$mean_12 + 1.5 * df_prices213$var_12)), alpha=0.4) + 
         geom_ribbon (aes(ymin = (df_prices213$mean_12 - v_std * df_prices213$var_12), 
                          ymax = (df_prices213$mean_12 + v_std * df_prices213$var_12)), fill = 'green', alpha=0.2) +
         ggtitle('2013 Gas-Oil Spread and MeanRev IC from 2012')


multiplot(p21, p22, p23, p211, p212, p213, cols = 2)

# mean_13  <- spread131[1]* exp(-coef(fit12)[2]*t13) + (coef(fit12)[1] / coef(fit12)[2]) * (1-exp(-coef(fit12)[2]*t13))
# var_13  <- (coef(fit12)[3]^2 / (2*coef(fit12)[2])) * (1-exp(-2*coef(fit12)[2]*t13))
# var_13   <- sqrt(var_12)
...
# v_std <- std(2,1,na.fill(MovingVol13,"extend"))
